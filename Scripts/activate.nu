...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\DATA Science\pythonProject\Body_Fat_Estimator'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\DATA Science\pythonProject\Body_Fat_Estimator\Scripts\deactivate.nu'
